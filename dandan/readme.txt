...
The "bigspider.py" is used to crawl urls of boards(∞Ê√Ê), and "myspider.py" 
crawl list and content of article.
...
It is notable that because of limits of authority, some article 
can't be read. Remember to change the user and password in const.py
when you use.